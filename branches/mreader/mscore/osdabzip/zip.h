...
public:
	...
	ErrorCode createEntry(const QString& entryName, QIODevice& actualFile, QDateTime dt, bool dirOnly = false, bool isPNGFile = false, Zip::CompressionLevel level = Deflate9);
