...
QScriptValue qtscript_create_QWindowStateChangeEvent_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 3; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QWindowStateChangeEvent_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QWindowStateChangeEvent_static_call, proto, function_lengths[0]);
