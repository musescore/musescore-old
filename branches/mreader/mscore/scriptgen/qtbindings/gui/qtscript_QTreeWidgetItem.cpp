...
QScriptValue qtscript_create_QTreeWidgetItem_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 57; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QTreeWidgetItem_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QTreeWidgetItem_static_call, proto, function_lengths[0]);
