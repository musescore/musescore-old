...
QtScriptShell_QFontDialog::QtScriptShell_QFontDialog(QWidget*  parent)
    : QFontDialog(parent) {}

QtScriptShell_QFontDialog::QtScriptShell_QFontDialog(const QFont&  initial, QWidget*  parent)
