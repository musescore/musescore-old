...
QScriptValue qtscript_create_QProgressBar_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 3; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QProgressBar_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QProgressBar_static_call, proto, function_lengths[0]);
