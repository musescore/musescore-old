...
QScriptValue qtscript_create_QGraphicsSceneMouseEvent_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 25; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QGraphicsSceneMouseEvent_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QGraphicsSceneMouseEvent_static_call, proto, function_lengths[0]);
