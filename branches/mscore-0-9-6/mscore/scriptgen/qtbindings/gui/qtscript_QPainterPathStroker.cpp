...
QScriptValue qtscript_create_QPainterPathStroker_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 16; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QPainterPathStroker_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QPainterPathStroker_static_call, proto, function_lengths[0]);
