...
\starttext
   ...
   \startstandardmakeup[page=no]
      ...
      \ConTeXt.
      \blank[line]
      \copyright 2005-2007 Werner Schweer and Others
      \stopstandardmakeup
   ...
   \section{What is \M?}
      ...
      \startitemize[packed]
            ...
            \item \M\ uses TrueType fonts for printing and screen display.
                  This allows for high quality scaling to all sizes.
            \item Notes can be entered fast and simple by only using the keyboard.
            \item MusicXML import/export
            \item Midi (SMF) import/export
