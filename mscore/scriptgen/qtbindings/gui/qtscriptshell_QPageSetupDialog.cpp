...
QtScriptShell_QPageSetupDialog::QtScriptShell_QPageSetupDialog(QPrinter*  printer, QWidget*  parent)
    : QPageSetupDialog(printer, parent) {}

QtScriptShell_QPageSetupDialog::QtScriptShell_QPageSetupDialog(QWidget*  parent)
    : QPageSetupDialog(parent) {}

QtScriptShell_QPageSetupDialog::~QtScriptShell_QPageSetupDialog() {}

void QtScriptShell_QPageSetupDialog::accept()
{
...
void QtScriptShell_QPageSetupDialog::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QPageSetupDialog::devType() const
{
...
void QtScriptShell_QPageSetupDialog::done(int  result)
{
...
void QtScriptShell_QPageSetupDialog::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QPageSetupDialog::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QPageSetupDialog::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
int  QtScriptShell_QPageSetupDialog::exec()
{
...
void QtScriptShell_QPageSetupDialog::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QPageSetupDialog::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QPageSetupDialog::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_QPageSetupDialog::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QPageSetupDialog::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QPageSetupDialog::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QPageSetupDialog::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::languageChange()
{
...
void QtScriptShell_QPageSetupDialog::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QPageSetupDialog::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QPageSetupDialog::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QPageSetupDialog::paintEngine() const
{
...
void QtScriptShell_QPageSetupDialog::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::reject()
{
...
void QtScriptShell_QPageSetupDialog::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QPageSetupDialog::wheelEvent(QWheelEvent*  arg__1)
{
