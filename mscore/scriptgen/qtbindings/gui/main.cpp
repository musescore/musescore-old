...
static const QtBindingCreator qtscript_com_trolltech_qt_gui_class_functions[] = {
    ...
    , qtscript_create_QTextBlockUserData_class
    , qtscript_create_QStyleHintReturn_class
    , qtscript_create_QStandardItem_class
    , qtscript_create_QImageWriter_class
    , qtscript_create_QInputContextFactory_class
    , qtscript_create_QTextTableCell_class
    , qtscript_create_QTextDocumentFragment_class
    , qtscript_create_QKeySequence_class
    , qtscript_create_QTextFragment_class
    , qtscript_create_QToolTip_class
    , qtscript_create_QLineF_class
    , qtscript_create_QPainterPathStroker_class
    , qtscript_create_QWhatsThis_class
    , qtscript_create_QTextObjectInterface_class
    , qtscript_create_QItemEditorCreatorBase_class
    , qtscript_create_QPen_class
    , qtscript_create_QPolygonF_class
    ...
    , qtscript_create_QPixmapCache_class
    , qtscript_create_QMatrix_class
    ...
    , qtscript_create_QTextLength_class
    , qtscript_create_QStyleFactory_class
    , qtscript_create_QAccessible2Interface_class
    ...
    , qtscript_create_QPainter_class
    , qtscript_create_QRegion_class
    , qtscript_create_QReadWriteLock_class
    , qtscript_create_QDesktopServices_class
    , qtscript_create_QItemSelection_class
    , qtscript_create_QPictureIO_class
    , qtscript_create_QTransform_class
    , qtscript_create_QImageReader_class
    , qtscript_create_QAccessibleBridge_class
    , qtscript_create_QTableWidgetSelectionRange_class
    , qtscript_create_QItemEditorFactory_class
    , qtscript_create_QTextItem_class
    , qtscript_create_QTextFormat_class
    , qtscript_create_QPaintEngine_class
    , qtscript_create_QColor_class
    , qtscript_create_QPalette_class
    , qtscript_create_QTextLine_class
    , qtscript_create_QIconEngine_class
    , qtscript_create_QAccessible_class
    , qtscript_create_QTextCursor_class
    , qtscript_create_QImageIOHandler_class
    , qtscript_create_QTextInlineObject_class
    , qtscript_create_QPolygon_class
    , qtscript_create_QSizePolicy_class
    , qtscript_create_QGraphicsItem_class
    , qtscript_create_QGraphicsLayoutItem_class
    , qtscript_create_QPaintEngineState_class
    , qtscript_create_QPainterPath_class
    , qtscript_create_QCursor_class
    , qtscript_create_QFontInfo_class
    , qtscript_create_QValidator_class
    , qtscript_create_QImageIOPlugin_class
    , qtscript_create_QStyleOptionButton_class
    , qtscript_create_QFocusEvent_class
    , qtscript_create_QGraphicsItemAnimation_class
    , qtscript_create_QShortcutEvent_class
    ...
    , qtscript_create_QInputContextPlugin_class
    , qtscript_create_QStyleOptionToolBox_class
    , qtscript_create_QStatusTipEvent_class
    , qtscript_create_QSyntaxHighlighter_class
    ...
    , qtscript_create_QIconDragEvent_class
    , qtscript_create_QMovie_class
    , qtscript_create_QGraphicsLayout_class
    , qtscript_create_QTextDocument_class
    , qtscript_create_QTextListFormat_class
    , qtscript_create_QAccessibleEvent_class
    , qtscript_create_QItemSelectionModel_class
    , qtscript_create_QInputContext_class
    , qtscript_create_QHoverEvent_class
    , qtscript_create_QMoveEvent_class
    , qtscript_create_QHideEvent_class
    , qtscript_create_QWindowStateChangeEvent_class
    , qtscript_create_QIconEnginePluginV2_class
    , qtscript_create_QShowEvent_class
    , qtscript_create_QStyleOptionHeader_class
    , qtscript_create_QImage_class
    , qtscript_create_QHelpEvent_class
    , qtscript_create_QAccessiblePlugin_class
    , qtscript_create_QGraphicsLineItem_class
    , qtscript_create_QStyleOptionTab_class
    , qtscript_create_QTextFrameFormat_class
    , qtscript_create_QLayout_class
    , qtscript_create_QClipboardEvent_class
    ...
    , qtscript_create_QDragResponseEvent_class
    , qtscript_create_QAccessibleTableInterface_class
    , qtscript_create_QStyleOptionDockWidget_class
    , qtscript_create_QStylePainter_class
    , qtscript_create_QDragLeaveEvent_class
    ...
    , qtscript_create_QDropEvent_class
    , qtscript_create_QWidgetItem_class
    , qtscript_create_QToolBarChangeEvent_class
    ...
    , qtscript_create_QAccessibleObject_class
    , qtscript_create_QStyleOptionDockWidgetV2_class
    ...
    , qtscript_create_QStyleOptionProgressBarV2_class
    , qtscript_create_QStackedLayout_class
    , qtscript_create_QWorkspace_class
    , qtscript_create_QStyledItemDelegate_class
    , qtscript_create_QStyleOptionFrameV2_class
    , qtscript_create_QStyleOptionTabV2_class
    ...
    , qtscript_create_QMotifStyle_class
    , qtscript_create_QStyleOptionViewItemV3_class
    , qtscript_create_QTextList_class
    , qtscript_create_QDoubleSpinBox_class
    , qtscript_create_QAccessibleWidget_class
    ...
    , qtscript_create_QWindowsStyle_class
    , qtscript_create_QDragEnterEvent_class
    , qtscript_create_QAccessibleObjectEx_class
    , qtscript_create_QStringListModel_class
    , qtscript_create_QStackedWidget_class
    , qtscript_create_QAbstractPageSetupDialog_class
    ...
    , qtscript_create_QTextTable_class
    ...
    , qtscript_create_QStyleOptionViewItemV4_class
    ...
    , qtscript_create_QCDEStyle_class
    , qtscript_create_QPageSetupDialog_class
    , qtscript_create_QAccessibleWidgetEx_class
    ...
    , qtscript_create_QPlastiqueStyle_class
    , qtscript_create_QScrollArea_class
    , qtscript_create_QCleanlooksStyle_class
