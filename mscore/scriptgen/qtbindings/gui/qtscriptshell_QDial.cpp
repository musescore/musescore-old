...
QtScriptShell_QDial::QtScriptShell_QDial(QWidget*  parent)
    : QDial(parent) {}
...
bool  QtScriptShell_QDial::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QDial::mouseMoveEvent(QMouseEvent*  me)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, me));
    }
}
...
void QtScriptShell_QDial::resizeEvent(QResizeEvent*  re)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, re));
    }
}
