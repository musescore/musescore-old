...
QScriptValue qtscript_create_QPaintEngineState_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 20; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QPaintEngineState_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QPaintEngineState_static_call, proto, function_lengths[0]);
