...
QScriptValue qtscript_create_QFontMetrics_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 24; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QFontMetrics_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QFontMetrics_static_call, proto, function_lengths[0]);
