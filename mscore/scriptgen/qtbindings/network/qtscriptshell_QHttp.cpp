...
QtScriptShell_QHttp::QtScriptShell_QHttp(QObject*  parent)
    : QHttp(parent) {}

QtScriptShell_QHttp::QtScriptShell_QHttp(const QString&  hostname, QHttp::ConnectionMode  mode, unsigned short  port, QObject*  parent)
    : QHttp(hostname, mode, port, parent) {}

QtScriptShell_QHttp::QtScriptShell_QHttp(const QString&  hostname, unsigned short  port, QObject*  parent)
...
bool  QtScriptShell_QHttp::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
