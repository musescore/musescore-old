      ...
      Rectangle {
            ...
            ScoreView {
                  ...
                  MouseArea {
                        ...
                        onPressed: {
                              parent.startX = mouseX
                              parent.time = new Date().getTime();
                              }
                        onReleased: {
                              var dtime = new Date().getTime() - parent.time;
                              var dx = mouseX - parent.startX
                              if (dx > 100) {
                              ...
                              else if (((dx >= 0) && (dx < 10)) || ((dx <= 0) && (dx > -10))) {
                                    if (dtime < 120) {
                                          console.log("clicked")
                                          if (mouseX > parent.width * .9)
                                                scoreView.nextPage();
                                          else if (mouseX < parent.width * .1)
                                                scoreView.prevPage();
                                          else {
