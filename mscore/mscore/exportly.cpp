...
void ExportLy::symbol(Symbol* sym)
	...
	out << "\\mark \\markup {\\musicglyph #\"scripts.lcomma\"} ";
      //      else if (name == "flageolet")out << "\\flageolet ";
      else {
...
bool ExportLy::flaglettest(Note* n)
{
  bool flageolett = false;
