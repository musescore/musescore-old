...
LanguageItem languages[] = {
      ...
      LanguageItem("ar",    QT_TRANSLATE_NOOP("language","العربية")),
      LanguageItem("ca",    QT_TRANSLATE_NOOP("language","Català")),
      ...
      LanguageItem("pt",    QT_TRANSLATE_NOOP("language","Português")),
      LanguageItem("pt_BR", QT_TRANSLATE_NOOP("language","Português brasileiro")),
      LanguageItem("ro",    QT_TRANSLATE_NOOP("language","Română")),
      LanguageItem("ru",    QT_TRANSLATE_NOOP("language","Русский")),
      LanguageItem("sv",    QT_TRANSLATE_NOOP("language","Svenska")),
      LanguageItem("th",    QT_TRANSLATE_NOOP("language","ภาษาไทย")),
      LanguageItem("tr",    QT_TRANSLATE_NOOP("language","Türkçe")),
      LanguageItem("uk",    QT_TRANSLATE_NOOP("language","Ukrajina")),
      LanguageItem("zh_TW", QT_TRANSLATE_NOOP("language","繁體中文 (台灣)")),
      };
