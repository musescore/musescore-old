...
void genIcons()
      ...
      icons[longaUp_ICON]        = symIcon(symbols[0][longaupSym], 20, iw, ih);
      icons[brevis_ICON]         = symIcon(symbols[0][brevisheadSym], 20, iw, ih);
      icons[note_ICON]           = symIcon(symbols[0][wholeheadSym], 20, iw, ih);
      icons[note2_ICON]          = symIcon(symbols[0][note2Sym], 20, iw, ih);
      icons[note4_ICON]          = symIcon(symbols[0][note4Sym], 20, iw, ih);
      icons[note8_ICON]          = symIcon(symbols[0][note8Sym], 20, iw, ih);
      icons[note16_ICON]         = symIcon(symbols[0][note16Sym], 20, iw, ih);
      icons[note32_ICON]         = symIcon(symbols[0][note32Sym], 20, iw, ih);
      icons[note64_ICON]         = symIcon(symbols[0][note64Sym], 20, iw, ih);
      icons[natural_ICON]        = symIcon(symbols[0][naturalSym], 30, iw, ih);
      icons[sharp_ICON]          = symIcon(symbols[0][sharpSym], 30, iw, ih);
      icons[sharpsharp_ICON]     = symIcon(symbols[0][sharpsharpSym], 30, iw, ih);
      icons[flat_ICON]           = symIcon(symbols[0][flatSym], 30, iw, ih);
      icons[flatflat_ICON]       = symIcon(symbols[0][flatflatSym], 30, iw, ih);
      icons[quartrest_ICON]      = symIcon(symbols[0][rest4Sym], 30, iw, ih);
      icons[dot_ICON]            = symIcon(symbols[0][dotSym], 30, iw, ih);
      icons[dotdot_ICON]         = symIcon(symbols[0][dotdotSym], 30, iw, ih);
      icons[sforzatoaccent_ICON] = symIcon(symbols[0][sforzatoaccentSym], 20, iw, ih);
      icons[staccato_ICON]       = symIcon(symbols[0][staccatoSym], 20, iw, ih);
      icons[tenuto_ICON]         = symIcon(symbols[0][tenutoSym], 20, iw, ih);
      icons[plus_ICON]           = symIcon(symbols[0][plusSym], 30, iw, ih);
      icons[clef_ICON]           = symIcon(symbols[0][trebleclefSym], 17, iw, ih);
      icons[staccato_ICON]       = symIcon(symbols[0][dotSym], 30, iw, ih);   //":/data/staccato.svg");
