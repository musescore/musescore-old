...
QScriptValue qtscript_create_QItemEditorCreatorBase_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 3; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QItemEditorCreatorBase_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QItemEditorCreatorBase_static_call, proto, function_lengths[0]);
