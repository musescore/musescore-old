...
QScriptValue qtscript_create_QXmlAttributes_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 11; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QXmlAttributes_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QXmlAttributes_static_call, proto, function_lengths[0]);
