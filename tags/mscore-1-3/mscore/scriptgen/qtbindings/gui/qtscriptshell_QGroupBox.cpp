...
QtScriptShell_QGroupBox::QtScriptShell_QGroupBox(QWidget*  parent)
    : QGroupBox(parent) {}

QtScriptShell_QGroupBox::QtScriptShell_QGroupBox(const QString&  title, QWidget*  parent)
...
bool  QtScriptShell_QGroupBox::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
