...
Create new Score from Scratch  </h5>
    ...
    then you can add empty measures.
          <ul>
  <li>
&lt;<b>I</b>&gt; popups the instrument menu    </li>
  <li>
&lt;<b>Ctrl+B</b>&gt; appends an empty measure    </li>
  <li>
then menu &lt;<b>Create/Measures</b>&gt; can be used to create
...
,
          <a href="timesig.php">
set time signature  </a>
<h5>
Create new Score from Template  </h5>
    ...
    <h5>
Create new Score with the New Wizard  </h5>
