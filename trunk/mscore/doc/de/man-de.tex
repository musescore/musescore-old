...
\stoptyping
      ...
      \M\ schreibt/liest im Hintergrund zwei weitere Dateien:
            ...
            \NC \type{~/.mscorePrj} \NC enth�ie zuletzt
              bearbeiteten Partituren\NC\NR
            \stoptabulate
            \blank[big]
...
%----------------------------------------------------------
   ...
   \section{Noten Eingabe}
      ...
      F�e Eingabe von Intervallen gibt es folgende
      Kommandos:
      ...
      beide Teile.
            ...
            \startitemize[packed]
                  ...
                  \item einen aktuellen X11 Server mit freetype2 Support
                        und Render Extension (f�tialiased Bildschirmfonts).
            \stopitemize
...
\stoptyping
      ...
      mit dem die Qt-Library compilert wurden.
      \StopFrame
...
\chapter{Tastaturabkürzungen}
      ...
      \Sc{Left}   Note zurpar
      \Sc{Alt+Up}\crlf selektiert h� Note im Akkord oder niedrigste
                  Note der h�n Notenzeile\par
      \Sc{Alt+Down}\crlf selektiert niedrigere Note im Akkord oder die h�e
                    Note der n�en Notenzeile.\par
      \Sc{Alt+Ctrl+Up}  \crlf selektiert die h�e Note im Akkord\par
