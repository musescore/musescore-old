...
class Measure : public MeasureBase {
   ...
   public:
      ...
      void setEndBarLineType(BarLineType val, bool g, bool visible = true, Color color = Color(0, 0, 0));
      ...
      Color endBarLineColor() const            { return _endBarLineColor;     }
