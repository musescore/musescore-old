...
%
% (C) 2005-2008 Copyright: Werner Schweer
%====================================================================
...
%----------------------------------------------------------
   ...
   \startstandardmakeup[page=no]
      ...
      \blank[line]
      \copyright 2005-2008 Werner Schweer und Andere
      \stopstandardmakeup
      }
...
\subsection{Editieren}
   ...
   \startitemize[packed]
      ...
      \item durch tippen von \type{Strg+M} können weitere leere Takte
            angehängt werden
      \item \type{Strg+Scrollrad} wird die Notendarstellung vergrößert
            bzw. verkleinert.
   \stopitemize
...
\chapter{Referenz}
   \section{Kommandozeile Optionen}
...
\stoptyping
      ...
      Es gibt folgende Optionen:
            ...
            \NC -i \NC alle Midi Input Events werden auf der Konsole protokolliert\NC\NR
            \NC -L \NC startete \M\ im Layout-Debug Mode\NC\NR
            \NC -m \NC startete \M\ ohne MIDI Input Support\NC\NR
            \NC -o name \NC \M\ diese startet den ''Konverter''-Mode. \M\ liest
                eine Datei und gibt sie unter ''name'' wieder aus. Das
                Ausgabeformat bestimmt sich dabei aus der Namensendung.\NC\NR
   ...
   \section{Menüs}
      ...
      \Opt{Öffnen} zeigt einen Dateiauswahldialog, der es erlaubt, eine
          weitere Partitur zu öffnen. Auch können verschiedene Dateiformate
          importiert d.h. in eine \M\ Partitur umgewandelt werden.\index{Import}
          Es können gleichzeitig mehrere Partituren geöffnet sein, die dann
          über Karteireiter auswählbar sind.\par
      ...
      \Opt{Sichern unter} schreibt die aktuelle Partitur unter einem
        zu wählenden Namen auf die Festplatte. Es erscheint ein Dateiauswahldialog
        der es auch erlaubt, die Partitur in verschiedene Formate
        zu exportieren.\index{Export}\par
      \Opt{Schließen} schließt die aktuelle Partitur und entfernt den
        entsprechenden Karteireiter. ''Schließen'' ist nur aktiv, wenn
        mehrere Partituren geöffnet sind.\par
      ...
      \Opt{Redo}  Der Zustand vor dem letzten ''Undo'' wird wiederhergestellt.

      \Opt{Cut}   Verschiebt die aktuell ausgewählten Elemente in die
                  Zwischenablage.

      \Opt{Copy}  Kopiert die aktuell ausgewählten Elemnte in die
                  Zwischenablage.
...
\section{Bindebögen}
      ...
      Note erzeugt. Der Bindebogen startet im Edit-Modus, d.h. mit
      der Tastenkombination Shift+right kann der Bindebogen jeweils zur
      nächsten Note verlängert werden.

      Im Edit-Modus werden vier Kontrollpunkte
...
\section{Text}
      ...
      \subsection{Liedtext}
            ...
            \startnarrower[left]
            \starttabulate[|l|p|]
            \NC\bf Strg+L      \NC startet die Texteingabe. Ein Textblock erscheint
                                unter der ausgewählten Note\NC\MR
            \NC\bf Leertaste    \NC positioniert den Cursor zur nächsten Note
                                   (nächste Silbe)\NC\MR
            \NC\bf Shift+Leertaste \NC positioniert den Cursor zur vorherigen Note
                                   (vorherige Silbe)\NC\MR
            \NC\bf --          \NC positioniert den Cursor zur nächsten Silbe
                                   und verbindet beide Silben mit einer Linie\NC\MR
            \NC\bf Ctrl+Leertaste \NC erstellt ein Leerzeichen im Liedtext\NC\MR
            \NC\bf Ctrl+ --       \NC erstellt ein -- im Liedtext\NC\MR
      ...
      \subsection{Akkordnamen}

            Um einen Akkordnamen einzugeben muß zunächst eine Note
            ausgewählt werden.

            \startnarrower[left]
            \starttabulate[|l|p|]
            \NC\bf Strg+K      \NC startet die Texteingabe. Ein Textblock erscheint
                                über der ausgewählten Note\NC\MR
            \NC\bf Leertaste    \NC positioniert den Cursor zum nächsten Akkord \NC\MR
            \NC\bf Shift+Leertaste \NC positioniert den Cursor zum vorherigen Akkord
                                   \NC\MR
            \NC\bf Ctrl+Leertaste \NC erstellt ein Leerzeichen im Akkordnamen\NC\MR
