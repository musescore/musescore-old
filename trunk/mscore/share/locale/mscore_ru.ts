...
&quot;%1&quot; перед закрытием?</translation>
    ...
    <message>
        ...
        <translation>Все поддерживаемые файлы (*.mscz *.msc *.xml *.mxl *.mid *.kar *.md *.ly *.mgu *.MGU *.sgu *.SGU *.cap);;Файлы MuseScore (*.mscz *.msc);;Файлы MusicXML (*.xml *.mxl);;Файлы MIDI (*.mid *.kar);;Файлы Muse Data (*.md);;Файлы Capella (*.cap);;Файлы LilyPond &lt;экспериментально&gt; (*.ly);;Файлы BB &lt;экспериментально&gt; (*.mgu *.MGU *.sgu *.SGU);;Все файлы (*)</translation>
    </message>
    <message>
        <source></source>
        <translation></translation>
