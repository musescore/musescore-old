...
QScriptValue qtscript_create_QGraphicsLayoutItem_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 30; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QGraphicsLayoutItem_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QGraphicsLayoutItem_static_call, proto, function_lengths[0]);
