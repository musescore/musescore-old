...
static QScriptValue qtscript_QTextDocumentFragment_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    if (!_q_self) {
        return context->throwError(QScriptContext::TypeError,
            ...
            .arg(qtscript_QTextDocumentFragment_function_names[_id+1]));
    }
...
QScriptValue qtscript_create_QTextDocumentFragment_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 4; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QTextDocumentFragment_prototype_call, function_lengths[i+3]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QTextDocumentFragment_static_call, proto, function_lengths[0]);
