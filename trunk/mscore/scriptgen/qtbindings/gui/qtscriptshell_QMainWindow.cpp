...
QtScriptShell_QMainWindow::QtScriptShell_QMainWindow(QWidget*  parent, Qt::WindowFlags  flags)
    : QMainWindow(parent, flags) {}

QtScriptShell_QMainWindow::~QtScriptShell_QMainWindow() {}

void QtScriptShell_QMainWindow::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::contextMenuEvent(QContextMenuEvent*  event)
{
...
QMenu*  QtScriptShell_QMainWindow::createPopupMenu()
{
    QScriptValue _q_function = __qtscript_self.property("createPopupMenu");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("createPopupMenu") & QScriptValue::QObjectMember)) {
        return QMainWindow::createPopupMenu();
    } else {
        return qscriptvalue_cast<QMenu* >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_QMainWindow::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QMainWindow::devType() const
{
...
void QtScriptShell_QMainWindow::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QMainWindow::event(QEvent*  event)
{
...
bool  QtScriptShell_QMainWindow::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QMainWindow::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QMainWindow::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QMainWindow::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_QMainWindow::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QMainWindow::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QMainWindow::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QMainWindow::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::languageChange()
{
...
void QtScriptShell_QMainWindow::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QMainWindow::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QMainWindow::minimumSizeHint() const
{
...
void QtScriptShell_QMainWindow::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QMainWindow::paintEngine() const
{
...
void QtScriptShell_QMainWindow::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_QMainWindow::sizeHint() const
{
...
void QtScriptShell_QMainWindow::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QMainWindow::wheelEvent(QWheelEvent*  arg__1)
{
