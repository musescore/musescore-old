...
QtScriptShell_QToolBar::QtScriptShell_QToolBar(QWidget*  parent)
    : QToolBar(parent) {}

QtScriptShell_QToolBar::QtScriptShell_QToolBar(const QString&  title, QWidget*  parent)
    : QToolBar(title, parent) {}

QtScriptShell_QToolBar::~QtScriptShell_QToolBar() {}

void QtScriptShell_QToolBar::actionEvent(QActionEvent*  event)
{
...
void QtScriptShell_QToolBar::changeEvent(QEvent*  event)
{
...
void QtScriptShell_QToolBar::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QToolBar::devType() const
{
...
void QtScriptShell_QToolBar::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QToolBar::event(QEvent*  event)
{
...
bool  QtScriptShell_QToolBar::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QToolBar::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QToolBar::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QToolBar::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_QToolBar::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QToolBar::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QToolBar::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QToolBar::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QToolBar::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QToolBar::minimumSizeHint() const
{
...
void QtScriptShell_QToolBar::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QToolBar::paintEngine() const
{
...
void QtScriptShell_QToolBar::paintEvent(QPaintEvent*  event)
{
...
void QtScriptShell_QToolBar::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_QToolBar::sizeHint() const
{
...
void QtScriptShell_QToolBar::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QToolBar::wheelEvent(QWheelEvent*  arg__1)
{
