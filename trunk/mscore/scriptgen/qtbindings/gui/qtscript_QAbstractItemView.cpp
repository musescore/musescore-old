...
QScriptValue qtscript_create_QAbstractItemView_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 24; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QAbstractItemView_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QAbstractItemView_static_call, proto, function_lengths[0]);
