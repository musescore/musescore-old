...
QScriptValue qtscript_create_QAbstractScrollArea_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 13; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QAbstractScrollArea_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QAbstractScrollArea_static_call, proto, function_lengths[0]);
