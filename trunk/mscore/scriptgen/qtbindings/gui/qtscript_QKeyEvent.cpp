...
QScriptValue qtscript_create_QKeyEvent_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 10; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QKeyEvent_prototype_call, function_lengths[i+2]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QKeyEvent_static_call, proto, function_lengths[0]);
