...
QScriptValue qtscript_create_QGraphicsGridLayout_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 38; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QGraphicsGridLayout_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QGraphicsGridLayout_static_call, proto, function_lengths[0]);
