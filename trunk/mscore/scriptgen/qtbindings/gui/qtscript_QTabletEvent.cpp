...
QScriptValue qtscript_create_QTabletEvent_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 19; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QTabletEvent_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QTabletEvent_static_call, proto, function_lengths[0]);
