...
{ \
    ...
    { \
        ...
        if (!metatype_id) \
            metatype_id = qRegisterMetaType< QPair<qreal,QPointF> >("QPair<qreal,QPointF>"); \
        return metatype_id; \
    } \
};
template <> \
...
{ \
    ...
    { \
        static QBasicAtomicInt metatype_id = Q_BASIC_ATOMIC_INITIALIZER(0); \
        if (!metatype_id) \
            metatype_id = qRegisterMetaType< QList<QPair<qreal,QPointF> > >("QList<QPair<qreal,QPointF> >"); \
        return metatype_id; \
    } \
};
template <> \
...
{ \
    ...
    { \
        static QBasicAtomicInt metatype_id = Q_BASIC_ATOMIC_INITIALIZER(0); \
        if (!metatype_id) \
            metatype_id = qRegisterMetaType< QPair<qreal,qreal> >("QPair<qreal,qreal>"); \
        return metatype_id; \
    } \
};
template <> \
...
{ \
    ...
    { \
        static QBasicAtomicInt metatype_id = Q_BASIC_ATOMIC_INITIALIZER(0); \
        if (!metatype_id) \
            metatype_id = qRegisterMetaType< QList<QPair<qreal,qreal> > >("QList<QPair<qreal,qreal> >"); \
        return metatype_id; \
    } \
};
...
QScriptValue qtscript_create_QGraphicsItemAnimation_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 25; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QGraphicsItemAnimation_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QGraphicsItemAnimation_static_call, proto, function_lengths[0]);
