...
QScriptValue qtscript_create_QWebHistoryInterface_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 3; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QWebHistoryInterface_prototype_call, function_lengths[i+3]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QWebHistoryInterface_static_call, proto, function_lengths[0]);
