...
QScriptValue qtscript_create_QTcpServer_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 17; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QTcpServer_prototype_call, function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QTcpServer_static_call, proto, function_lengths[0]);
