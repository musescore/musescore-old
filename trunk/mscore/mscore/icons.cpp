...
void genIcons()
      ...
      icons[longaUp_ICON]        = symIcon(symbols[longaupSym], 20, iw, ih);
      icons[brevis_ICON]         = symIcon(symbols[brevisheadSym], 20, iw, ih);
      icons[note_ICON]           = symIcon(symbols[wholeheadSym], 20, iw, ih);
      icons[note2_ICON]          = symIcon(symbols[note2Sym], 20, iw, ih);
      icons[note4_ICON]          = symIcon(symbols[note4Sym], 20, iw, ih);
      icons[note8_ICON]          = symIcon(symbols[note8Sym], 20, iw, ih);
      icons[note16_ICON]         = symIcon(symbols[note16Sym], 20, iw, ih);
      icons[note32_ICON]         = symIcon(symbols[note32Sym], 20, iw, ih);
      icons[note64_ICON]         = symIcon(symbols[note64Sym], 20, iw, ih);
      icons[natural_ICON]        = symIcon(symbols[naturalSym], 30, iw, ih);
      icons[sharp_ICON]          = symIcon(symbols[sharpSym], 30, iw, ih);
      icons[sharpsharp_ICON]     = symIcon(symbols[sharpsharpSym], 30, iw, ih);
      icons[flat_ICON]           = symIcon(symbols[flatSym], 30, iw, ih);
      icons[flatflat_ICON]       = symIcon(symbols[flatflatSym], 30, iw, ih);
      icons[quartrest_ICON]      = symIcon(symbols[rest4Sym], 30, iw, ih);
      icons[dot_ICON]            = symIcon(symbols[dotSym], 30, iw, ih);
      icons[dotdot_ICON]         = symIcon(symbols[dotdotSym], 30, iw, ih);
