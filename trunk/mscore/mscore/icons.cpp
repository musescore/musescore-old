...
void genIcons()
      ...
      icons[longaUp_ICON]        = new QIcon(iconPath + "longaUp.png");
      icons[brevis_ICON]         = new QIcon(iconPath + "brevis.png");
      icons[note_ICON]           = new QIcon(iconPath + "note.png");
      icons[note2_ICON]          = new QIcon(iconPath + "note2.png");
      icons[note4_ICON]          = new QIcon(iconPath + "note4.png");
      icons[note8_ICON]          = new QIcon(iconPath + "note8.png");
      icons[note16_ICON]         = new QIcon(iconPath + "note16.png");
      icons[note32_ICON]         = new QIcon(iconPath + "note32.png");
      icons[note64_ICON]         = new QIcon(iconPath + "note64.png");
      icons[natural_ICON]        = new QIcon(iconPath + "natural.png");
      icons[sharp_ICON]          = new QIcon(iconPath + "sharp.png");
      icons[sharpsharp_ICON]     = new QIcon(iconPath + "sharpsharp.png");
      icons[flat_ICON]           = new QIcon(iconPath + "flat.png");
      icons[flatflat_ICON]       = new QIcon(iconPath + "flatflat.png");
      icons[quartrest_ICON]      = new QIcon(iconPath + "quartrest.png");
      icons[dot_ICON]            = new QIcon(iconPath + "dot.png");
      icons[dotdot_ICON]         = new QIcon(iconPath + "dotdot.png");
      icons[sforzatoaccent_ICON] = new QIcon(iconPath + "sforzatoaccent.png");
      icons[staccato_ICON]       = new QIcon(iconPath + "staccato.png");
      icons[tenuto_ICON]         = new QIcon(iconPath + "tenuto.png");
      icons[plus_ICON]           = new QIcon(iconPath + "plus.png");
      icons[clef_ICON]           = new QIcon(iconPath + "clef.png");
      icons[staccato_ICON]       = new QIcon(iconPath + "staccato.png");
