...
struct LilypondNames {
      ...
      const char* name;
            ...
            { brevisdoubleheadSym,  "noteheads.sM1double" },
            ...
            { snappizzicatoSym,     "scripts.snappizzicato" },

            { ushortfermataSym,     "scripts.ushortfermata" },
            { dshortfermataSym,     "scripts.dshortfermata" },
            { ulongfermataSym,      "scripts.ulongfermata" },
            { dlongfermataSym,      "scripts.dlongfermata" },
            { uverylongfermataSym,  "scripts.uverylongfermata" },
            { dverylongfermataSym,  "scripts.dverylongfermata" },
            ...
            { caesuraCurvedSym,     "scripts.caesura.curved" },
            { caesuraStraight,      "scripts.caesura.straight" },
