...
PPage::PPage(XRef *xrefA, int numA, Dict *pageDict, Ref pageRefA, PageAttrs *attrsA, Form *form) {
  Object tmp;
...
Annots *PPage::getAnnots(Catalog *catalog) {
  Annots *annots;
  Object obj;
...
void PPage::addAnnot(Annot *annot) {
  Object obj1;
  Object tmp;
...
Links *PPage::getLinks(Catalog *catalog) {
  Links *links;
  Object obj;
...
void PPage::display(OutputDev *out, double hDPI, double vDPI,
...
Gfx *PPage::createGfx(OutputDev *out, double hDPI, double vDPI,
		     int rotate, GBool useMediaBox, GBool crop,
...
void PPage::displaySlice(OutputDev *out, double hDPI, double vDPI,
			int rotate, GBool useMediaBox, GBool crop,
			int sliceX, int sliceY, int sliceW, int sliceH,
			GBool printing, Catalog *catalog,
			GBool (*abortCheckCbk)(void *data),
...
GBool PPage::loadThumb(unsigned char **data_out,
...
void PPage::makeBox(double hDPI, double vDPI, int rotate,
...
void PPage::processLinks(OutputDev *out, Catalog *catalog) {
  Links *links;
  int i;
...
void PPage::getDefaultCTM(double *ctm, double hDPI, double vDPI,
