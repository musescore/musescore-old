...
namespace Bww {
  ...
  Writer::Writer(QIODevice *outDevice)
    : out(outDevice),
    beats(4),
    beat(4),
    measureNumber(0)
  {
    qDebug() << "Writer::Writer()";
  ...
  void Writer::beginMeasure()
  {
    qDebug() << "Writer::beginMeasure()";
    ++measureNumber;
  ...
  void Writer::header(const QString title, const QString type,
                      const QString composer, const QString footer)
  {
    qDebug() << "Writer::header()"
        << "title:" << title
        << "type:" << type
        << "composer:" << composer
        << "footer:" << footer
  ...
  void Writer::tempo(const int bts, const int bt)
  {
    qDebug() << "Writer::tempo()"
        << "beats:" << bts
        << "beat:" << bt
  ...
  void Writer::endMeasure()
  {
    qDebug() << "Writer::endMeasure()";
    out << "    </measure>" << endl;
  }
  ...
  void Writer::note(const QString pitch, const QString /*TODO beam */,
