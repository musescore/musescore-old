...
int  MStyleConfigData::genericAnimationsDuration;
int  MStyleConfigData::toolBarAnimationsDuration;
...
bool MStyleConfigData::menuBarAnimationsEnabled;
bool MStyleConfigData::menuAnimationsEnabled;
int  MStyleConfigData::toolBarAnimationType;
