...
class ChordRest : public DurationElement {
   ...
   public:
      ...
      virtual void read(XmlReader*, const QList<Tuplet*>&, const QList<Slur*>&) = 0;
      bool readProperties(XmlReader* e, const QList<Tuplet*>&, const QList<Slur*>&);
      ...
      const TimeDuration& durationType() const               { return _durationType;        }
      void setDurationType(TimeDuration::DurationType t);
      void setDurationType(const QString& s);
      void setDurationType(int ticks);
      void setDurationType(const TimeDuration& v);
