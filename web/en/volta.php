<?php
  ...
  require("header.html");
  ?>
<h4><a href="idx.php">MuseScore</a> -- <a href="manual.php">Documentation</a> -- <a href="reference.pjhp">Index</a> -- Volta</h4>
...
<br/>
    ...
    enter  <a href="editmode.php">
edit mode  </a>
  and then move the handles
    with:
    <br/>
<br/>
